...
//! "Name's seam, pronounced shawm. And this is my little seap. Ha ha ha..."
...
class ProjectList implements DragTarget {
  ...
  constructor(private type: "active" | "finished") {
    ...
    this.hostEl = document.getElementById("app") as HTMLTemplateElement;
    const importTemplate = document.importNode(this.templateEl.content, true);
    this.element = importTemplate.querySelector("section") as HTMLElement;
